      ...
      <div className="flex items-center gap-4">
        ...
        {!isRegenerateDisable && (
          <button
            ...
            className="flex items-center gap-3 bg-[#3B82F6] border-2 border-[#3B82F6] p-3 rounded-xl text-white text-2xl  cursor-pointer">
            <svg
              width="15"
              height="15"
              viewBox="0 0 25 25"
        ...
        {isRegenerateDisable && (
          <button className="flex items-center gap-3 bg-[#3B82F6] border-2 border-[#3B82F6] p-3 rounded-xl text-white text-2xl  cursor-pointer">
            <svg
              width="15"
              height="20"
              viewBox="0 0 20 29"
